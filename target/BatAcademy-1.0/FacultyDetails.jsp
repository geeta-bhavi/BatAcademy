                    ...
                    <div id="searchResults" class="hide large-12 medium-12 columns">
                        <table class="courseTable" id="selectedCousesTable">
                            ...
                            <tr>
                                ...
                                <td><input class="allowEdit" id="enterActivity1" type="number"></td>
                                <td><input class="allowEdit" id="enterActivity2" type="number"></td>
                                <td><input class="allowEdit" id="enterActivity3" type="number"></td>
                            </tr>
                        </table>
                        <a href="#" id="updateActivity" class="button secondary">Confirm changes</a>
                    </div>
